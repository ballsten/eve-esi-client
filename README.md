...
```sh
pip install git+https://github.com/ballsten/GIT_REPO_ID.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/ballsten/GIT_REPO_ID.git`)
