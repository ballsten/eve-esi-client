...
class GetCharactersCharacterIdSkillqueue200Ok(BaseModel):
    """
    200 ok object
    """ # noqa: E501
    ...
    finished_level: Annotated[int, Field(le=5, strict=True, ge=0)] = Field(description="finished_level integer")
    level_end_sp: Optional[StrictInt] = Field(default=None, description="level_end_sp integer")
    ...
    queue_position: StrictInt = Field(description="queue_position integer")
    ...
    training_start_sp: Optional[StrictInt] = Field(default=None, description="training_start_sp integer")
