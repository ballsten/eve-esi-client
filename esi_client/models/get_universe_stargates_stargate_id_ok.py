...
class GetUniverseStargatesStargateIdOk(BaseModel):
    ...
    stargate_id: StrictInt = Field(description="stargate_id integer")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "destination": GetUniverseStargatesStargateIdDestination.from_dict(obj.get("destination")) if obj.get("destination") is not None else None,
            "name": obj.get("name"),
            "position": GetUniverseStargatesStargateIdPosition.from_dict(obj.get("position")) if obj.get("position") is not None else None,
