...
class DeleteCharactersCharacterIdMailLabelsLabelIdUnprocessableEntity(BaseModel):
    """
    Unprocessable entity
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, description="Unprocessable entity message")
