...
class GetCharactersCharacterIdWalletTransactions200Ok(BaseModel):
    """
    wallet transaction
    """ # noqa: E501
    ...
    is_personal: StrictBool = Field(description="is_personal boolean")
    journal_ref_id: StrictInt = Field(description="journal_ref_id integer")
