...
class PostCharactersCharacterIdAssetsLocations200Ok(BaseModel):
    """
    200 ok object
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "position": PostCharactersCharacterIdAssetsLocationsPosition.from_dict(obj.get("position")) if obj.get("position") is not None else None
        })
        return _obj
