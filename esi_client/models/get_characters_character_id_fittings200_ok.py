...
class GetCharactersCharacterIdFittings200Ok(BaseModel):
    """
    200 ok object
    """ # noqa: E501
    description: StrictStr = Field(description="description string")
    fitting_id: StrictInt = Field(description="fitting_id integer")
    items: Annotated[List[GetCharactersCharacterIdFittingsItem], Field(max_length=512)] = Field(description="items array")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [GetCharactersCharacterIdFittingsItem.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "name": obj.get("name"),
