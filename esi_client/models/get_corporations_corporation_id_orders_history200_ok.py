...
class GetCorporationsCorporationIdOrdersHistory200Ok(BaseModel):
    """
    200 ok object
    """ # noqa: E501
    ...
    wallet_division: Annotated[int, Field(le=7, strict=True, ge=1)] = Field(description="The corporation wallet division used for this order")
    ...
    def state_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('cancelled', 'expired'):
