...
class GetCorporationsCorporationIdContactsLabels200Ok(BaseModel):
    """
    200 ok object
    """ # noqa: E501
    label_id: StrictInt = Field(description="label_id integer")
    label_name: StrictStr = Field(description="label_name string")
