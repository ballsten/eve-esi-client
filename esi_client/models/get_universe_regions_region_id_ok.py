...
class GetUniverseRegionsRegionIdOk(BaseModel):
    ...
    200 ok object
    """ # noqa: E501
    constellations: Annotated[List[StrictInt], Field(max_length=1000)] = Field(description="constellations array")
    ...
    region_id: StrictInt = Field(description="region_id integer")
