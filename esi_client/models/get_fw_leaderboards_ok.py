...
class GetFwLeaderboardsOk(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "kills": GetFwLeaderboardsKills.from_dict(obj.get("kills")) if obj.get("kills") is not None else None,
            "victory_points": GetFwLeaderboardsVictoryPoints.from_dict(obj.get("victory_points")) if obj.get("victory_points") is not None else None
        })
        return _obj
