...
class GetCorporationsCorporationIdBookmarksFolders200Ok(BaseModel):
    """
    200 ok object
    """ # noqa: E501
    creator_id: Optional[StrictInt] = Field(default=None, description="creator_id integer")
    folder_id: StrictInt = Field(description="folder_id integer")
    name: StrictStr = Field(description="name string")
    __properties: ClassVar[List[str]] = ["creator_id", "folder_id", "name"]
