...
class GetCharactersCharacterIdLocationOk(BaseModel):
    ...
    station_id: Optional[StrictInt] = Field(default=None, description="station_id integer")
    structure_id: Optional[StrictInt] = Field(default=None, description="structure_id integer")
