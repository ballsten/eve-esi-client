...
class GetCorporationsCorporationIdMembersTitles200Ok(BaseModel):
    """
    200 ok object
    """ # noqa: E501
    character_id: StrictInt = Field(description="character_id integer")
    titles: Annotated[List[StrictInt], Field(max_length=16)] = Field(description="A list of title_id")
