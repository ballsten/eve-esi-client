...
class GetFwStats200Ok(BaseModel):
    """
    200 ok object
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "kills": GetFwStatsKills.from_dict(obj.get("kills")) if obj.get("kills") is not None else None,
            "pilots": obj.get("pilots"),
            "systems_controlled": obj.get("systems_controlled"),
            "victory_points": GetFwStatsVictoryPoints.from_dict(obj.get("victory_points")) if obj.get("victory_points") is not None else None
        })
        return _obj
