...
class GetFwLeaderboardsCharactersOk(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "kills": GetFwLeaderboardsCharactersKills.from_dict(obj.get("kills")) if obj.get("kills") is not None else None,
            "victory_points": GetFwLeaderboardsCharactersVictoryPoints.from_dict(obj.get("victory_points")) if obj.get("victory_points") is not None else None
        })
        return _obj
