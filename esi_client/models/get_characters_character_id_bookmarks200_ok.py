...
class GetCharactersCharacterIdBookmarks200Ok(BaseModel):
    """
    200 ok object
    """ # noqa: E501
    bookmark_id: StrictInt = Field(description="bookmark_id integer")
    coordinates: Optional[GetCharactersCharacterIdBookmarksCoordinates] = None
    ...
    item: Optional[GetCharactersCharacterIdBookmarksItem] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "coordinates": GetCharactersCharacterIdBookmarksCoordinates.from_dict(obj.get("coordinates")) if obj.get("coordinates") is not None else None,
            "created": obj.get("created"),
            "creator_id": obj.get("creator_id"),
            "folder_id": obj.get("folder_id"),
            "item": GetCharactersCharacterIdBookmarksItem.from_dict(obj.get("item")) if obj.get("item") is not None else None,
            "label": obj.get("label"),
