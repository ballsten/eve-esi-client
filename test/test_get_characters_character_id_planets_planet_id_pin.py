...
class TestGetCharactersCharacterIdPlanetsPlanetIdPin(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCharactersCharacterIdPlanetsPlanetIdPin:
        """Test GetCharactersCharacterIdPlanetsPlanetIdPin
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCharactersCharacterIdPlanetsPlanetIdPin`
        """
        model = GetCharactersCharacterIdPlanetsPlanetIdPin()
        if include_optional:
            return GetCharactersCharacterIdPlanetsPlanetIdPin(
                contents = [
