...
class TestGetCorporationsCorporationIdContracts200Ok(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCorporationsCorporationIdContracts200Ok:
        """Test GetCorporationsCorporationIdContracts200Ok
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCorporationsCorporationIdContracts200Ok`
        """
        model = GetCorporationsCorporationIdContracts200Ok()
        if include_optional:
