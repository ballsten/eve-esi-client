...
class TestGetKillmailsKillmailIdKillmailHashVictim(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetKillmailsKillmailIdKillmailHashVictim:
        """Test GetKillmailsKillmailIdKillmailHashVictim
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetKillmailsKillmailIdKillmailHashVictim`
        """
        model = GetKillmailsKillmailIdKillmailHashVictim()
        if include_optional:
            return GetKillmailsKillmailIdKillmailHashVictim(
                alliance_id = 56,
                character_id = 56,
                corporation_id = 56,
                damage_taken = 56,
