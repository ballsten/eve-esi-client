...
class TestGetOpportunitiesTasksTaskIdOk(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetOpportunitiesTasksTaskIdOk:
        """Test GetOpportunitiesTasksTaskIdOk
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOpportunitiesTasksTaskIdOk`
        """
        model = GetOpportunitiesTasksTaskIdOk()
        if include_optional:
