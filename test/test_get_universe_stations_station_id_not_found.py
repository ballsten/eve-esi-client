...
class TestGetUniverseStationsStationIdNotFound(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetUniverseStationsStationIdNotFound:
        """Test GetUniverseStationsStationIdNotFound
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUniverseStationsStationIdNotFound`
        """
        model = GetUniverseStationsStationIdNotFound()
        if include_optional:
